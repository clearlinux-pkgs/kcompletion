...
Source0  : https://download.kde.org/stable/frameworks/5.50/kcompletion-5.50.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.50/kcompletion-5.50.0.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : LGPL-2.1
Requires: kcompletion-lib
Requires: kcompletion-license
Requires: kcompletion-data
...
export LANG=C
export SOURCE_DATE_EPOCH=1536424458
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1536424458
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/kcompletion
cp COPYING.LIB %{buildroot}/usr/share/doc/kcompletion/COPYING.LIB
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Completion.so.5.50.0

%files license
%defattr(-,root,root,-)
/usr/share/doc/kcompletion/COPYING.LIB
