...
Source0  : https://download.kde.org/stable/frameworks/5.48/kcompletion-5.48.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.48/kcompletion-5.48.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1532005442
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5Completion.so.5.48.0
