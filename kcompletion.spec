...
Version  : 5.110.0
Release  : 68
URL      : https://download.kde.org/stable/frameworks/5.110/kcompletion-5.110.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.110/kcompletion-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kcompletion-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kcompletion-5.110.0
cd %{_builddir}/kcompletion-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694454027
mkdir -p clr-build
pushd clr-build
