...
Version  : 6.1.0
Release  : 79
URL      : https://download.kde.org/stable/frameworks/6.1/kcompletion-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/kcompletion-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kcompletion-6.1.0.tar.xz.sig
...
%setup -q -n kcompletion-6.1.0
cd %{_builddir}/kcompletion-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712956733
mkdir -p clr-build
pushd clr-build
