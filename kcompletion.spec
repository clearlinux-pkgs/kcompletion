...
Source0  : https://download.kde.org/stable/frameworks/5.59/kcompletion-5.59.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.59/kcompletion-5.59.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1560023900
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5Completion.so.5.59.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/kcompletion/COPYING.LIB
