...
Version  : 5.106.0
Release  : 63
URL      : https://download.kde.org/stable/frameworks/5.106/kcompletion-5.106.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.106/kcompletion-5.106.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.106/kcompletion-5.106.0.tar.xz.sig
...
%prep
%setup -q -n kcompletion-5.106.0
cd %{_builddir}/kcompletion-5.106.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684817511
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Completion.so
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Completion.so.5
/V3/usr/lib64/libKF5Completion.so.5.106.0
/V3/usr/lib64/qt5/plugins/designer/kcompletion5widgets.so
/usr/lib64/libKF5Completion.so.5
/usr/lib64/libKF5Completion.so.5.106.0
