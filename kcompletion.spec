...
Source0  : https://download.kde.org/stable/frameworks/5.109/kcompletion-5.109.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.109/kcompletion-5.109.0.tar.xz.sig
...
%prep
%setup -q -n kcompletion-5.109.0
cd %{_builddir}/kcompletion-5.109.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693069999
mkdir -p clr-build
pushd clr-build
