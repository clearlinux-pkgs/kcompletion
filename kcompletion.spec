...
Source0  : https://download.kde.org/stable/frameworks/5.78/kcompletion-5.78.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.78/kcompletion-5.78.0.tar.xz.sig
...
%prep
%setup -q -n kcompletion-5.78.0
cd %{_builddir}/kcompletion-5.78.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611175146
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcompletion-5.78.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kcompletion/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kcompletion-5.78.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kcompletion/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kcompletion-5.78.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kcompletion/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Completion.so.5.78.0
